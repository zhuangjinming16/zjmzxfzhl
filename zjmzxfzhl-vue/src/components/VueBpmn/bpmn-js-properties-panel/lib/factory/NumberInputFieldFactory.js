...
var numberField = function(options, defaultParameters) {
  ...
  resource.html =
    ...
    '<div class="bpp-field-wrapper" ' +
      ...
      (canBeHidden ? 'data-show="isHidden"' : '') +
      '>' +
      '<input class="el-input" id="flowable-' + escapeHTML(resource.id) + '" type="number" name="' + escapeHTML(options.modelProperty) + '" ' +
        (canBeDisabled ? 'data-disable="isDisabled"' : '') +
        (canBeHidden ? 'data-show="isHidden"' : '') +
        ' />' +
