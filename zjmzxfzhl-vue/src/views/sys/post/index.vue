<template>
    <div class="app-container">
        <div class="filter-container">
            <el-input v-model="listQuery.postId" placeholder="岗位ID" style="width: 200px;" class="filter-item"
                      @keyup.enter.native="btnQuery"/>
            <el-input v-model="listQuery.postName" placeholder="岗位名称" style="width: 200px;" class="filter-item"
                      @keyup.enter.native="btnQuery"/>
            ...
            <el-button-group>
                <el-button v-permission="'sys:post:save'" icon="el-icon-plus" type="primary" @click="btnCreate"
                           class="filter-item">新增
                </el-button>
                <el-button v-permission="'sys:post:delete'" icon="el-icon-delete" @click="btnDelete()"
        ...
        >
            ...
            <el-table-column label="岗位ID" prop="postId" align="center">
                <template slot-scope="scope"><span>{{ scope.row.postId }}</span></template>
            </el-table-column>
            <el-table-column label="岗位名称" prop="postName" align="center">
                <template slot-scope="scope"><span>{{ scope.row.postName }}</span></template>
            </el-table-column>
                ...
                <template slot-scope="{row}">
                    <el-dropdown>
                        ...
                        <el-dropdown-menu slot="dropdown">
                            ...
                            <el-dropdown-item v-permission="'sys:post:update'" icon="el-icon-edit" divided
                                              @click.native="btnUpdate(row)">修改
                            </el-dropdown-item>
                            <el-dropdown-item v-permission="'sys:post:delete'" icon="el-icon-delete" divided
                                              @click.native="btnDelete(row.postId)">删除
                            </el-dropdown-item>
                            <el-dropdown-item v-permission="'sys:post:getPostUser'" icon="el-icon-setting" divided
                                              @click.native="btnPostUser(row.postId)">分配用户
                            </el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
                </template>
        ...
        <el-dialog title="岗位" :visible.sync="dialogFormVisible">
            <el-form ref="dataForm" :rules="rules" :model="temp" :disabled="dialogStatus==='view'"
                ...
                <el-form-item label="岗位ID" prop="postId">
                    <el-input v-model="temp.postId" :readonly="dialogStatus==='update'"/>
                </el-form-item>
        ...
        <el-dialog :title="postUserTitle" fullscreen :visible.sync="dialogPostUserVisible"
            ...
            <div class="filter-container">
                ...
                <el-button-group>
                    <el-button icon="el-icon-plus" type="primary" class="filter-item" @click="btnPostUserAdd">新增
                    </el-button>
