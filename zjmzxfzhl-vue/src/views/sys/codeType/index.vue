<template>
    <div class="app-container">
        <div class="filter-container">
            <el-input v-model="listQuery.codeTypeId" placeholder="代码类别ID" style="width: 200px;" class="filter-item"
                      @keyup.enter.native="btnQuery"/>
            <el-input v-model="listQuery.codeTypeName" placeholder="代码类别名称" style="width: 200px;" class="filter-item"
                      @keyup.enter.native="btnQuery"/>
            ...
            <el-button-group>
                <el-button v-permission="'sys:codeType:save'" icon="el-icon-plus" type="primary" @click="btnCreate"
                           class="filter-item">新增
                </el-button>
                <el-button v-permission="'sys:codeType:delete'" icon="el-icon-delete" @click="btnDelete()"
        ...
        >
            ...
            <el-table-column label="代码类别ID" prop="codeTypeId" align="center">
                <template slot-scope="scope"><span>{{ scope.row.codeTypeId }}</span></template>
            </el-table-column>
            <el-table-column label="代码类别名称" prop="codeTypeName" align="center">
                <template slot-scope="scope"><span>{{ scope.row.codeTypeName }}</span></template>
            </el-table-column>
                ...
                <template slot-scope="{row}">
                    <el-dropdown>
                        ...
                        <el-dropdown-menu slot="dropdown">
                            ...
                            <el-dropdown-item v-permission="'sys:codeType:update'" icon="el-icon-edit" divided
                                              @click.native="btnUpdate(row)">修改
                            </el-dropdown-item>
                            <el-dropdown-item v-permission="'sys:codeType:delete'" icon="el-icon-delete" divided
                                              @click.native="btnDelete(row.codeTypeId)">删除
                            </el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
                </template>
