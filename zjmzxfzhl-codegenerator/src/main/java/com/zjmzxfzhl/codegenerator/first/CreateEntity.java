...
public class CreateEntity {
    ...
    public static void create(String createTableName) {
        ...
        try {
            ...
            file.mkdirs();
            BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter(new File(filePath + aSysCodeType +
                    ".java")));
    ...
    private static void processingList(String sysCodeTypeFirstUpper, Object tableName, ArrayList<TableObject> list,
                                       StringBuffer stringBufferHead2, StringBuffer stringBufferMid,
                                       StringBuffer stringBufferFoot, TreeMap<String, String> importHashMap) {
        for (int i = 0; i < list.size(); i++) {
            ...
            if ("createBy".equals(codeTypeIdFirstLower) || "createDate".equals(codeTypeIdFirstLower) || "createTime".equals(codeTypeIdFirstLower) || "updateBy".equals(codeTypeIdFirstLower) || "updateDate".equals(codeTypeIdFirstLower) || "updateTime".equals(codeTypeIdFirstLower)) {
                continue;
            }
    ...
    private static void processingDataTypeDateTime(StringBuffer stringBufferMid, StringBuffer stringBufferFoot,
                                                   TreeMap<String, String> importHashMap, TableObject tableObject,
                                                   String codeTypeIdFirstUpper, String codeTypeIdFirstLower) {
        stringBufferMid.append("    " + "@JsonFormat(pattern = \"yyyy-MM-dd HH:mm:ss\", timezone = \"GMT+8\")" + "\r" +
                "\n");
        ...
        importHashMap.put("import org.springframework.format.annotation.DateTimeFormat;\r\n", "org.springframework" +
                ".format.annotation.DateTimeFormat;\r\n");
    }
    ...
    private static void processingDataTypeFloat(StringBuffer stringBufferMid, StringBuffer stringBufferFoot,
                                                TreeMap<String, String> importHashMap, TableObject tableObject,
                                                String codeTypeIdFirstUpper, String codeTypeIdFirstLower) {
        stringBufferMid.append("    " + "@DecimalMax(\"" + getMax(tableObject.getDataLength(),
                tableObject.getDataPrecision()) + "\")" + "\r\n");
    ...
    private static void processingDataTypeString(StringBuffer stringBufferMid, StringBuffer stringBufferFoot,
                                                 TableObject tableObject, String codeTypeIdFirstUpper,
