package com.zjmzxfzhl.framework.mybatisplus;
...
public class GlobalMetaObjectHandler implements MetaObjectHandler {
    ...
    private boolean isAppBaseEntity(MetaObject metaObject) {
        return metaObject.getOriginalObject() instanceof AppBaseEntity
                || (metaObject.hasGetter(Constants.ENTITY) && metaObject.getValue(Constants.ENTITY) != null
                        && metaObject.getValue(Constants.ENTITY) instanceof AppBaseEntity);
    }
