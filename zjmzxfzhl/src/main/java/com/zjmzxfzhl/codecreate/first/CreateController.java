...
public class CreateController {
	...
	public static void create(String createTableName, String templetPath) {
		...
		File actionFile = new File(
				CodeUtil.projectPath + "src\\main\\java\\com\\zjmzxfzhl\\codeCreate\\template\\" + templetPath + "\\Controller.txt");
		try {
		...
		try {
			String filePath = CodeUtil.projectPath + "src\\main\\java\\com\\zjmzxfzhl\\modules\\" + sys + "\\" + "\\controller\\";
