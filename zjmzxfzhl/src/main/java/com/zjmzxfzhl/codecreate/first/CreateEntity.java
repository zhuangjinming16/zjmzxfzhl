...
public class CreateEntity {
	...
	public static void create(String createTableName) {
		...
		for (Object tableName : hashMap.keySet()) {
			...
			processingList(aSysCodeType, tableName, list, stringBufferHead2, stringBufferMid, stringBufferFoot, importHashMap);
		...
		// 实体类.
		try {
			String filePath = CodeUtil.projectPath + "src\\main\\java\\com\\zjmzxfzhl\\modules\\" + sys + "\\" + "\\entity\\";
			File file = new File(filePath);
			file.mkdirs();
			BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter(new File(filePath + aSysCodeType + ".java")));
	...
	private static void processingList(String sysCodeTypeFirstUpper, Object tableName, ArrayList<TableObject> list, StringBuffer stringBufferHead2,
			StringBuffer stringBufferMid, StringBuffer stringBufferFoot, TreeMap<String, String> importHashMap) {
		for (int i = 0; i < list.size(); i++) {
			...
			if (i == 0) {
				...
				stringBufferHead2.append("public class " + sysCodeTypeFirstUpper + " extends BaseEntity {" + "\r\n\r\n");
			...
			if ("createBy".equals(codeTypeIdFirstLower) || "createDate".equals(codeTypeIdFirstLower) || "createTime".equals(codeTypeIdFirstLower)
					|| "updateBy".equals(codeTypeIdFirstLower) || "updateDate".equals(codeTypeIdFirstLower)
					|| "updateTime".equals(codeTypeIdFirstLower)) {
				continue;
			}
			...
			if ("字符型".equals(tableObject.getDataType())) {
				processingDataTypeString(stringBufferMid, stringBufferFoot, tableObject, codeTypeIdFirstUpper, codeTypeIdFirstLower);
			} else if ("整数型".equals(tableObject.getDataType())) {
				processingDataTypeInteger(stringBufferMid, stringBufferFoot, importHashMap, tableObject, codeTypeIdFirstUpper, codeTypeIdFirstLower);
			} else if ("浮点型".equals(tableObject.getDataType())) {
				processingDataTypeFloat(stringBufferMid, stringBufferFoot, importHashMap, tableObject, codeTypeIdFirstUpper, codeTypeIdFirstLower);
			} else if ("日期型".equals(tableObject.getDataType())) {
				processingDataTypeDate(stringBufferMid, stringBufferFoot, importHashMap, tableObject, codeTypeIdFirstUpper, codeTypeIdFirstLower);
			} else if ("时间型".equals(tableObject.getDataType())) {
				processingDataTypeDateTime(stringBufferMid, stringBufferFoot, importHashMap, tableObject, codeTypeIdFirstUpper, codeTypeIdFirstLower);
			}
		}
	}

	private static void processingDataTypeDateTime(StringBuffer stringBufferMid, StringBuffer stringBufferFoot, TreeMap<String, String> importHashMap,
		...
		stringBufferFoot.append("\t" + "public void set" + codeTypeIdFirstUpper + "(Date " + codeTypeIdFirstLower + ") {" + "\r\n");
	...
	private static void processingDataTypeDate(StringBuffer stringBufferMid, StringBuffer stringBufferFoot, TreeMap<String, String> importHashMap,
			TableObject tableObject, String codeTypeIdFirstUpper, String codeTypeIdFirstLower) {
	...
	private static void processingDataTypeFloat(StringBuffer stringBufferMid, StringBuffer stringBufferFoot, TreeMap<String, String> importHashMap,
			TableObject tableObject, String codeTypeIdFirstUpper, String codeTypeIdFirstLower) {
	...
	private static void processingDataTypeInteger(StringBuffer stringBufferMid, StringBuffer stringBufferFoot, TreeMap<String, String> importHashMap,
			TableObject tableObject, String codeTypeIdFirstUpper, String codeTypeIdFirstLower) {
		if (CommonUtil.isEmptyStr(tableObject.getDataLength()) || Integer.valueOf(tableObject.getDataLength()) < LENGTH) {
	...
	private static void processingDataTypeString(StringBuffer stringBufferMid, StringBuffer stringBufferFoot, TableObject tableObject,
			String codeTypeIdFirstUpper, String codeTypeIdFirstLower) {
		...
		stringBufferFoot.append("\t\t" + "return this." + codeTypeIdFirstLower + ";\r\n");
		stringBufferFoot.append("\t" + "}" + "\r\n\r\n");
		stringBufferFoot.append("\t" + "public void set" + codeTypeIdFirstUpper + "(String " + codeTypeIdFirstLower + ") {" + "\r\n");
		stringBufferFoot.append("\t\t" + "this." + codeTypeIdFirstLower + " = " + codeTypeIdFirstLower + ";\r\n");
		stringBufferFoot.append("\t" + "}" + "\r\n\r\n");
	}
