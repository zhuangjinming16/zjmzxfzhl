...
public class CreateService {
    ...
    public static void create(String createTableName, String templetPath) {
        ...
        // 读取模板内容
        File serviceFile = new File(CodeUtil.projectPath + "src\\main\\java\\com\\zjmzxfzhl\\codeCreate\\template\\"
                + templetPath + "\\Service.txt");
        try {
        ...
        try {
            ...
            BufferedWriter bufferedWriter = new BufferedWriter(
                    new FileWriter(new File(filePath + aSys + aCodeType + "Service.java")));
