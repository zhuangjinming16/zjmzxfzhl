...
public class CreateService {
	...
	public static void create(String createTableName, String templetPath) {
		...
		// 读取模板内容
		File serviceFile = new File(CodeUtil.projectPath + "src\\main\\java\\com\\zjmzxfzhl\\codeCreate\\template\\" + templetPath + "\\Service.txt");
		try {
		...
		// Service的Service类.
		try {
			String filePath = CodeUtil.projectPath + "src\\main\\java\\com\\zjmzxfzhl\\modules\\" + _sys + "\\" + "\\service\\";
			File file = new File(filePath);
			file.mkdirs();
			BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter(new File(filePath + _Sys + _CodeType + "Service.java")));
