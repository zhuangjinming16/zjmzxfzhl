...
public class TableObject {
	...
	private String sortNo;// 字段序号
	private String columnNameEn; // 字段英文名
	private String columnNameCn;// 字段中文名
	private String dataType; // 字段类型
	private String dataLength; // 字段长度
	private String dataPrecision;// 字段精度
	private String isNull; // 字段是否可空
	private boolean isList;// 字段是否列表
	private boolean isSearch;// 字段是否查询
	private String codeTypeId;// 下拉框ID
