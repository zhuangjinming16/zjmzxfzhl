...
public class DemoZjmzxfzhlController extends BaseController {
	...
	public R list(DemoZjmzxfzhl demoZjmzxfzhl, @RequestParam Integer current, @RequestParam Integer size) {
		...
		// IPage<DemoZjmzxfzhl> pageList = demoZjmzxfzhlService.listDataPermission3(new Page<DemoZjmzxfzhl>(current, size), demoZjmzxfzhl);

		// DemoZjmzxfzhl demoZjmzxfzhl2 = new DemoZjmzxfzhl();
		// BeanUtils.copyProperties(demoZjmzxfzhl, demoZjmzxfzhl2);
		// IPage<DemoZjmzxfzhl> pageList = demoZjmzxfzhlService.listDataPermission4(new Page<DemoZjmzxfzhl>(current, size), demoZjmzxfzhl,
		// demoZjmzxfzhl2);
