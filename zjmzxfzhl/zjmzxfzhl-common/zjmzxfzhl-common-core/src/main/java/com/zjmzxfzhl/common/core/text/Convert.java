package com.zjmzxfzhl.common.core.text;
...
public class Convert {
    ...
    public static Character toChar(Object value, Character defaultValue) {
        ...
        return CommonUtil.isEmptyStr(valueStr) ? defaultValue : valueStr.charAt(0);
    }
    ...
    public static Byte toByte(Object value, Byte defaultValue) {
        ...
        final String valueStr = toStr(value, null);
        if (CommonUtil.isEmptyStr(valueStr)) {
            return defaultValue;
        }
        try {
    ...
    public static String str(byte[] bytes, String charset) {
        return str(bytes, CommonUtil.isEmptyStr(charset) ? Charset.defaultCharset() : Charset.forName(charset));
    }
