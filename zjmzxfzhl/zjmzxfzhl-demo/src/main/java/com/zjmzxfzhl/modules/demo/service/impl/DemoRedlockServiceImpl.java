...
public class DemoRedlockServiceImpl implements DemoRedlockService {
    ...
    public void redlock5(String someId, int someInt, DemoZjmzxfzhl demoZjmzxfzhl1, DemoZjmzxfzhl demoZjmzxfzhl2)
            throws Exception {
        Thread.sleep(2000);
        log.info("锁第一个参数、第二个参数、第三个参数的zjmzxfzhlId属性、第四个参数的zjmzxfzhlId属性组合：" + someId + "," + someInt + ","
                + demoZjmzxfzhl1.getZjmzxfzhlId() + "," + demoZjmzxfzhl2.getZjmzxfzhlId());
    }
    ...
    public void redlock6(String someId, int someInt, DemoZjmzxfzhl demoZjmzxfzhl1) throws Exception {
        Thread.sleep(2000);
        log.info("锁第一个参数、第二个参数、第三个参数的zjmzxfzhlId属性、第三个参数的zjmzxfzhlName属性组合：" + someId + "," + someInt + ","
                + demoZjmzxfzhl1.getZjmzxfzhlId() + "," + demoZjmzxfzhl1.getZjmzxfzhlName());
    }
}
